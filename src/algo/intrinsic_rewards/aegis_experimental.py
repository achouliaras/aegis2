...
class AEGIS(IntrinsicRewardBaseModel):
    ...
    def _get_training_losses(self,
        ...
        # lmdp_loss = 0.2*fwd_loss + contrastive_loss
    ...
    def get_intrinsic_rewards(self,
        ...
        for env_id in range(batch_size):
            ...
            # global_rewards[env_id] = global_novelty[env_id] + 1.0
            # global_rewards[env_id] = th.pow(max(global_novelty[env_id] - last_global_novelty[env_id] * self.novelty_alpha, self.novelty_beta) + 1.0, 2.0)
