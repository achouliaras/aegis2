...
if __name__ == "__main__":
    ...
    modes = ["HalfPreTrain"]
    algos_to_compare = ["AEGIS_1e-3", "AEGIS_5e-3", "AEGIS", "AEGIS_5e-2", "AEGIS_1e-1", "AEGIS_5e-1", "AEGIS_1"]
    
    for mode in modes:
        for env in envs:
            out_file = f"abl_int_rew_coef.png"
